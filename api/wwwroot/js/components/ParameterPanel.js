...
const PARAM_DEFS = {
  photosynthesis: [
    ...
    { key:'parPhotosynthesis_waterStressSensitivity',   label:'Water stress sens.',  min:0.2,   max:0.8,   step:0.05,  def:0.5,   desc:'Water stress sensitivity slope' },
  ...
  respiration: [
    ...
    { key:'parRespiration_Tref',                        label:'T reference (°C)',    min:10,    max:20,    step:0.5,   def:15.0,  desc:'Reference temperature for Lloyd–Taylor respiration' },
